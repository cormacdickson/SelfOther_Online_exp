...
*/
var jsPsychRDK = (function (jspsych) {
  'use strict';		
	...
	const info = {
	    ...
	    parameters: {
		    ...
		    fixation_cross: {
		      type: jspsych.ParameterType.INT, //boolean
	 ...
	 class RDKPlugin {
      constructor(jsPsych) {
		...
		*/
		...
		// Cormacadded this line following error:assignment to undeclared variable on line 652
		var RDKArray;	
